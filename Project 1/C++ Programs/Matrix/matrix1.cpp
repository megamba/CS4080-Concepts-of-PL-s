...
void matrixAddition(float matrix1[100][100], float matrix2[100][100], int r1, int c1, int r2, int c2){
    float result[r1][c1];
...
void matrixSubtraction(float matrix1[100][100], float matrix2[100][100], int r1, int c1, int r2, int c2){
    float result[r1][c1];
...
void matrixMultiplication(float matrix1[100][100], float matrix2[100][100], int r1, int c1, int r2, int c2){
    float result[r1][c2];
